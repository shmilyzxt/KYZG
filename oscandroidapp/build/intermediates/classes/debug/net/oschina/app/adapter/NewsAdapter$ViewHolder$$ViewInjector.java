...
public class NewsAdapter$ViewHolder$$ViewInjector {
  public static void inject(Finder finder, final net.oschina.app.adapter.NewsAdapter.ViewHolder target, Object source) {
    View view;
    ...
    view = finder.findRequiredView(source, 2131362273, "field 'link'");
    target.link = (android.widget.ImageView) view;
  }

  public static void reset(net.oschina.app.adapter.NewsAdapter.ViewHolder target) {
    target.title = null;
