...
public class FriendAdapter$ViewHolder$$ViewInjector {
  public static void inject(Finder finder, final net.oschina.app.adapter.FriendAdapter.ViewHolder target, Object source) {
    View view;
  ...
  public static void reset(net.oschina.app.adapter.FriendAdapter.ViewHolder target) {
    target.name = null;
    target.from = null;
    target.desc = null;
    target.gender = null;
